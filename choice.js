class Choice{
    ...
    scissor(){
        ...
        scissor.className = 'scissor-game to-delete'
        scissor.innerHTML = `
        <div class="paper">
      ...
      document.querySelector('.circle-2').style.display = 'none';
        const circle2 = document.querySelector('.com')
        circle2.appendChild(scissor)
        document.querySelector('.container').style.display = 'none'
        document.querySelector('.result-container').style.display = 'block'
    }
    rock(){
        const rock = document.createElement("div");
        rock.className = 'rock-game to-delete'
        rock.innerHTML = `<div class="rock">
      ...
      document.querySelector('.circle-2').style.display = 'none';
        const circle2 = document.querySelector('.com')
        circle2.appendChild(rock)
        document.querySelector('.container').style.display = 'none'
        document.querySelector('.result-container').style.display = 'block'
    }
    paper(){
        const paper = document.createElement("div");
        paper.className = 'paper-game to-delete'
        paper.innerHTML = `
        <div class="paper">
    ...
    playerScissor(){
      ...
      document.querySelector('.circle-1').style.display = 'none';
        const circle2 = document.querySelector('.player')
        circle2.appendChild(scissor)
        document.querySelector('.container').style.display = 'none'
        document.querySelector('.result-container').style.display = 'block'
    }
    ...
    tired(data,data1){
        document.querySelector('.circle-1').style.display = 'none';
        document.querySelector('.circle-2').style.display = 'none';
        const circle1 = document.querySelector('.player')
        const circle2 = document.querySelector('.com')
        circle1.appendChild(data1)
        circle2.appendChild(data)
        document.querySelector('.container').style.display = 'none'
        document.querySelector('.result-container').style.display = 'block'
    }
}
